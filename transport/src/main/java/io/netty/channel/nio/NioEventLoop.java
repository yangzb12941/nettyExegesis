...
public final class NioEventLoop extends SingleThreadEventLoop {
    ...
    private void processSelectedKey(SelectionKey k, AbstractNioChannel ch) {
        ...
        try {
            ...
            //如果当前NioEventLoop是Worker
            //线程的话，那么就是OP_READ事件，也就是读事件，表示客户端发来了数据流，会调用Unsafe的read()方法进行读取。
            //如果是Worker线程，那么这里的Channel是NioServerSocketChannel ， 其 绑 定 的 Unsafe 是
            //NioByteUnsafe，会调用NioByteUnsafe的read()方法
